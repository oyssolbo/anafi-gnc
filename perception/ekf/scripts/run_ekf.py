...
from anafi_uav_msgs.msg import PointWithCovarianceStamped, EulerPose, AnafiTelemetry
import numpy as np
...
class EKFRosRunner():
    ...
    def _get_estimate_publisher(self, output_states: str):
        if output_states == "position":
            publisher = rospy.Publisher(
                ...
                PointWithCovarianceStamped, queue_size=10
            )
        else:
    ...
    def _drone_velocity_cb(self, msg: Vector3Stamped):
        ...
        z = np.array([msg.vector.x, msg.vector.y, msg.vector.z])
