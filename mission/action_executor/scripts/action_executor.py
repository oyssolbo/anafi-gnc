...
class MissionController():
    ...
    def __init__(self) -> None:
        ...
        mission_plan_params = utilities.load_config(node_name, "mission_plan_config_file")
        self._locations, self._locations_type = self._load_locations(mission_plan_params)

        control_params = utilities.load_control_params_config(node_name)
    ...
    def track_helipad(self, action: str):
        ...
        while not rospy.is_shutdown():
            ...
            v_d = self._controller.get_smooth_reference(v_d, v_ref[:2], dt) # Why is this from the controller???
